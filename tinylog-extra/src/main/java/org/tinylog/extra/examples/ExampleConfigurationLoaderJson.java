...
public final class ExampleConfigurationLoaderJson {

	/** */
	private ExampleConfigurationLoaderJson() {
	...
	public static void main(final String[] args) {
		...
		// System.setProperty("tinylog.configurationloader", JsonConfigurationLoader.class.getName());
